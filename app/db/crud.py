...
class OtrazhenieDB(Database):
    ...
    def show_all_tables(self):
        """
        Возвращает список всех таблиц, которые есть в базе данных
        """
        inspector = self.inspect
    ...
    def show_table_columns(self, table_name: str):
        """
        Показывает колонки конкретной таблицы
        """
        inspector = self.inspect
    ...
    def select_all_products(self):
        """Возвращает все категории из таблицы products"""
        with self.get_session() as session:
...
if __name__ == '__main__':
    ...
    # db.show_table_columns("products")
