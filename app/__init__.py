from flask import Flask, flash, redirect, url_for, CSRFError
...
def create_app():
    ...
    try:
        ...
        raise RuntimeError("SECRET_KEY не установлен! Установите его в .env или в переменной среды (environment variables)")
